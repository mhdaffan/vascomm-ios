...
extension UIView {
    ...
    func addShadow(shadowColor: UIColor = .black, shadowOffset: CGSize = CGSize(width: 0, height: 3), shadowOpacity: Float = 0.3, shadowRadius: CGFloat = 5, shouldRasterize: Bool = false) {
